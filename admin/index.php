...
<div id="menu">
  <ul>
    <li><img src="../img/home.png" width="40" height="40" style="padding-right:15px;cursor:pointer;" title="Inicio" onclick="location.href='#'" /></li>
    <li><a href="index.php" id="activo">Admin</a></li>
    <li><a href="consultas/">Consultas</a></li>
    <li><a href="registro-autos/">Vehículos en Alquiler</a></li>
  </ul>
</div>
<div id="fondo"/>
<div id="cabecera">
...
<div class="cont" style="margin-top:20px;">
  ...
  <p>Bienvenido al sistema administrativo de reservaciones de vehículos de Alquilauto Mérida.<br /><br />

Por favor <strong>seleccione</strong> una de las opciones del menú superior para continuar.</p>
</div>
